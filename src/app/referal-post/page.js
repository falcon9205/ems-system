...
export default function JobPostingPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("/api/referaljob", {
        method: "POST",
        headers: {
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="location"
                  name="location"
                  placeholder="e.g. New York, Noida or Remote"
                  value={location}
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="location"
                  name="location"
                  placeholder="e.g. Company email,12FRE#ZE etc"
                  value={referralid}
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  id="location"
                  name="location"
                  placeholder="company job profile link/personal Email address"
                  value={applylink}
